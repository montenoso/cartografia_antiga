...
var periUrl = "http://montenoso.net/cartografia/postgis2geojson.php";
...
switcherControl.maximizeControl();
    ...
    periLayer = new OpenLayers.Layer.Vector("Perímetros dos Montes. </br>Achégate en zoom para poder velos en cada área", {
    ...
    centroidLayer = new OpenLayers.Layer.Vector("Montes asociados por proximidade", {
	projection:"EPSG:4326" ,
  ...
  selectControl = new OpenLayers.Control.SelectFeature([centroidLayer,periLayer]);
  //selectControl = new OpenLayers.Control.SelectFeature(centroidLayer, periLayer);
...
//Engadir capa MapQuest
            ...
            console.log(mapQuest.getZIndex());
...
//Aerial
        ...
        baseAerial = new OpenLayers.Layer.OSM("Areo", arrayAerial);
       
        map.addLayer(baseAerial);
        console.log(baseAerial.getZIndex()) ;          
...
// markers = new OpenLayers.Layer.Markers( "Documentos" );
//    markers.id = "Markers";
//    map.addLayer(markers);		
//    console.log(markers.getZIndex());   
       
//    var size = new OpenLayers.Size(32,37); //tamaÃ±o del icono!!!
...
//argozÃ³n
    var feature = new OpenLayers.Feature.Vector(
            ...
            {description: '<div id="tot"><div id="tit">O FARO DE ARGOZÃ“N (Chantada)</div><br><img src="images/argozon.jpg"><br/><br/><b> <input type="button" href="javascript:void(0);" value ="RELATO ARGOZÃ“N" onclick="Cargar1()"></b><br/>  '},
            {externalGraphic: 'images/marcadores/proba.gif', graphicHeight: 37, graphicWidth: 32, graphicXOffset:-12, graphicYOffset:-25  }
        );    
    vectorLayer.addFeatures(feature);
//ombre
    var feature = new OpenLayers.Feature.Vector(
            new OpenLayers.Geometry.Point( -8.162209, 43.389581 ).transform(epsg4326, projectTo),
            {description:'<div id="tot"><div id="tit">OMBRE (A CoruÃ±a)</div><br><img src="images/ombre.jpg"><br/><br/><b><input type="button" href="javascript:void(0);" value ="RELATO OMBRE" onclick="Cargar2()"> </b><br/>  '},
            {externalGraphic: 'images/marcadores/proba.gif', graphicHeight: 37, graphicWidth: 32, graphicXOffset:-12, graphicYOffset:-25  }
        );    
    vectorLayer.addFeatures(feature);
//mouriscados
